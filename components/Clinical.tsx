const programs = [
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M6 3h8l2 5-10 0L8 3z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>
        <path d="M4 8h12v2a6 6 0 01-12 0V8z" stroke="currentColor" strokeWidth="1.4"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M10 2l2 6h6l-5 4 2 6-5-4-5 4 2-6-5-4h6z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M4 5h12M4 10h8M4 15h6" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/>
      </svg>
    ),
...
export default function Clinical() {
  return (
    <section id="clinical" className="py-28 px-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <br />
            Beyond Medication Orders
          </h2>
          <p className="text-[#8b93a8] max-w-xl mx-auto leading-relaxed">
            Two-thirds of our pharmacists hold specialized training or advanced
            degrees. We help you design and manage clinical programs that move
            the dial on patient care.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {programs.map((p, i) => (
            <div
              key={i}
              className="service-card rounded-xl border border-[#1a1c2e] bg-[#0d0e1a] p-5 flex flex-col gap-3"
            >
              <div className="w-9 h-9 rounded-lg bg-[#1a1c2e] flex items-center justify-center text-[#4a9eff]">
                {p.icon}
              </div>
              <h3
              ...
              <p className="text-[#6b7280] text-xs leading-relaxed">{p.desc}</p>
            </div>
          ))}
        </div>
      </div>
